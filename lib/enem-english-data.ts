...
const options = (a:string,b:string,c:string,d:string,e:string): EnemEnglishOption[] => [
...
export const enemEnglishReadings: EnemEnglishReading[] = [
  ...
  },
  {
    ...
    options:options("criticá-la pela restrição temática.","vinculá-la ao universo acadêmico.","afastá-la da abordagem socrática.","aproximá-la dos problemas sociais.","responsabilizá-la pela pobreza humana."), correct:"D",
    explanation:"Davis condiciona o valor da filosofia à sua relevância para problemas humanos e à superação de pobreza e opressão.",
  ...
  },
  {
    ...
    options:options("potência dos astros celestes.","origem das plantas e dos animais.","importância do apego à terra natal.","relação entre seres humanos e natureza.","conexão entre o tempo real e o tempo imaginário."), correct:"D",
  ...
  },
  {
    ...
    options:options("abordar obstáculos impostos a universitários.","destacar mensagens de incentivo a estudantes.","estimular ações proativas em situações de emergência.","retratar relações conflituosas em ambiente universitário.","apontar posturas de uma juventude avessa a contrariedades."), correct:"E",
    explanation:"O próprio texto define a expressão como estudantes delicados que não conseguem lidar com ideias controversas, isto é, avessos a contrariedades.",
  ...
  {
    id:"enem-eng-05", day:3, slot:1, year:2025, application:"Aplicação regular · Dia 1", questionLabel:"Questão 05 · caderno azul", title:"What is sleep?", kind:"visual", paragraphs:[],
    source:"Disponível em: pt.foursquare.com · acesso em 14 maio 2024.",
    visual:{ variant:"cups", lines:["I slept 8–10 h","I slept 5–7 h","What is sleep?"], description:"Recriação esquemática: três copos de café aumentam de tamanho conforme diminuem as horas de sono.", note:"O material informa que apenas “What is sleep?” foi recuperado literalmente; os rótulos dos copos menor e médio são apresentados no material como correspondência explicativa." },
    questionExcerpt:[`What is sleep?`],
    question:"Nesse texto, a pergunta \"What is sleep?\", em uma das embalagens do produto, está relacionada ao(à)",
    options:options("escassez de horas de sono.","estímulo a um descanso de qualidade.","gasto com bebidas que combatem a insônia.","consumo de bebidas que causam dependência.","necessidade de um produto que provoque o sono."), correct:"A",
    explanation:"No copo maior, a pergunta ironiza quem praticamente não dorme: quanto menos sono, maior a necessidade de café.",
    glossary:{ slept:"dormi", sleep:"sono/dormir" },
  },
  {
