...
export default function RevisoesPage() {
  return (
    <PageShell>
      ...
      <Suspense fallback={<div className="mx-auto grid min-h-72 w-full max-w-[1260px] place-items-center rounded-[28px] border border-[var(--border)] bg-[var(--surface)] text-sm text-[var(--muted)]">Carregando calendário...</div>}>
