import { ArrowRight, ImageIcon, Languages } from "lucide-react";
    ...
    <PageShell>
      <div className="mx-auto w-full max-w-[1080px] px-4 pb-24 pt-7 sm:px-6 sm:pt-10">
        <section className="overflow-hidden rounded-[30px] border border-sky-400/15 bg-[radial-gradient(circle_at_85%_0%,rgba(56,189,248,.12),transparent_40%),#08090d] p-6 text-white sm:p-8">
          ...
          <p className="mt-4 max-w-3xl text-xs leading-6 text-white/45">Primeiro lote: 10 dias. A questão só é liberada depois da leitura. Palavras podem ser traduzidas ao passar o mouse e salvas com um clique.</p>
        </section>
