  ...
  return (
    <PageShell>
      <div className="mx-auto w-full max-w-[1180px] px-4 pb-24 pt-6 sm:px-6 sm:pt-8">
        ...
        <header className="py-7 sm:py-9"><span className="inline-flex items-center gap-2 text-[10px] font-black tracking-[.2em] text-[var(--gold-bright)]"><BookOpenCheck size={16} /> ADMINISTRAÇÃO</span><h1 className="mt-3 font-serif text-4xl tracking-[-.04em] text-[var(--ink)] sm:text-6xl">Banco de questões.</h1><p className="mt-4 max-w-3xl text-sm leading-7 text-[var(--muted)]">Cadastre questões, importe lotes e acompanhe quando cada aula atingir as 35 questões necessárias.</p></header>
