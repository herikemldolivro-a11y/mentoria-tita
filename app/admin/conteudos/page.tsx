    ...
    <PageShell>
      <div className="mx-auto w-full max-w-[1180px] px-4 pb-20 pt-6 sm:px-6 sm:pt-8">
        ...
        <section className="py-7 sm:py-9">
          ...
          <p className="mt-4 max-w-3xl text-sm leading-7 text-[var(--muted)]">Envie ou substitua PDFs sem mexer no código. O arquivo é salvo no Supabase Storage, ligado à aula e liberado automaticamente no leitor do aluno.</p>
        </section>

        <AdminContentManager
          lessons={(lessonRows ?? []) as AdminLesson[]}
          initialMaterials={(materialRows ?? []) as AdminMaterial[]}
        />
      </div>
    </PageShell>
  );
